...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Alternative 2:")]),_v(" Individual command knows how to undo/redo by\nitself.\n"),_c('ul',[_c('li',[_v("Pros: Will use less memory (e.g. for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(", just save the person being deleted).")]),_v(" "),_c('li',[_v("Cons: We must ensure that the implementation of each individual command are correct.")])])])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"implemented-searching-for-students"}},[_v("[Implemented] Searching for students"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#implemented-searching-for-students","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("add new students to a class")]),_v(" "),_c('td',[_v("maintain an up-to-date list of enrolled students.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("add partial info of students")]),_v(" "),_c('td',[_v("still add students even if I don’t have all their information.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("delete a student from my class if they drop the module/class")]),_v(" "),_c('td',[_v("keep my class list accurate and up-to-date.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * ")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("search for my students based on their NUS ID, emails, names or tutorial groups")]),_v(" "),_c('td',[_v("locate details of students without having to go through the entire list")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("view all students and their particulars")]),_v(" "),_c('td',[_v("have a comprehensive overview of the enrolled students in my class.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("add/remove different modules I am teaching")]),_v(" "),_c('td',[_v("manage my teaching assignments efficiently.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("view all the tutorial classes and their information")]),_v(" "),_c('td',[_v("visibility into the schedule and details of all tutorial classes.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Fri, 29 Mar 2024, 14:31:27 GMT+8]")])])])}
}];
